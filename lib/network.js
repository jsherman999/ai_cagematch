...
export async function jsonRequest(url,{method='GET',headers={},body,signal,service='Service',fetchImpl=globalThis.fetch}={}){
 ...
 try{
  ...
  if(timeout.aborted)throw new AppError(`${service} timed out. Try again or choose a faster model.`);
